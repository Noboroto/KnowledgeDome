...
| S-12 | **Pre-flight chạy theo vòng hay theo cả playlist** sau Đ-5 (Đ-5.g). Phần luật nằm ở GRR-133/GRR-118. | E-5 |
...
> Phần **luật** của cùng bộ quyết định này ghi ở `docs/reviews/game-rules-decisions.md` §11, mã **Đ-16 → Đ-21**. Mục này chỉ ghi **hệ quả cấp sản phẩm**: giao diện phải làm gì, epic nào chịu ảnh hưởng, khoảng trống nào mới mở ra.
