...
> Phần **luật** của cùng bộ quyết định này ghi ở `docs/reviews/game-rules-decisions.md` §11, mã **Đ-16 → Đ-31**. Mục này chỉ ghi **hệ quả cấp sản phẩm**: giao diện phải làm gì, epic nào chịu ảnh hưởng, khoảng trống nào mới mở ra.
