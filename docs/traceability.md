...
| **Quyết định** | `decisions.md` — `QĐ-001` → `QĐ-066` | Source of truth về **lựa chọn sản phẩm** |
...
Chỉ **một** mục, và nó **không chặn** việc viết luật hay engine:

| Mục | Vì sao chưa quyết được |
|---|---|
| **Quy mô viewer và ngưỡng độ trễ** | Là con số phi chức năng — bao nhiêu viewer đồng thời, độ trễ bao nhiêu là đạt. Không rule nào hàm ý được con số này; nó đến từ điều kiện phần cứng và quy mô buổi thi thật. Xem `decisions.md` §N |
