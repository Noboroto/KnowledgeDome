...
**104 quyết định `QĐ-001` → `QĐ-104`.** Mỗi mục trả lời ba câu: quyết định là gì · vì sao chọn nó và bác cái gì · hệ quả kéo theo.
...
| Mã | Ở đâu | Là gì |
|---|---|---|
| `QĐ-001` → `QĐ-104` | `decisions.md` | Quyết định |
