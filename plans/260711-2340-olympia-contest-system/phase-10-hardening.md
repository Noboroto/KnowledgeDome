...
1. Load test (k6 + socket.io client): kịch bản preset O26 (4 thí sinh) + kịch bản 12 thí sinh CÁ NHÂN (12 thiết bị — `TEAM_12` theo đội dời Phase 12/v2) + 500 viewer, buzzer storm 50 đồng thời; đo p95 latency event < 200ms LAN / < 500ms Internet; tìm bottleneck. Bổ sung: đo băng thông encrypted-preload (D12b) với video 200MB (trần D6) trên 12 client đồng thời.
