...
| C9 — đáp án Chướng ngại vật | Ngoài phạm vi rule về **thời điểm**: nó lộ khi có người giải **đúng**, hoặc khi admin bấm **công bố** | Lần xem của phiên giữ `PERM-045` vẫn ghi theo FR-013; cú lộ theo `GR-012` thuộc `specs/006` | AC-008 |
